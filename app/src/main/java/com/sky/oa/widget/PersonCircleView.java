 ...
 * @Version: 1.0
 */
public class PersonCircleView extends View {

    public PersonCircleView(Context context) {
        this(context, null);
    }

    public PersonCircleView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public PersonCircleView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void canvasCircle(Canvas canvas) {
        ...
        paint.setColor(ContextCompat.getColor(getContext(), R.color.cardview_dark_background));
