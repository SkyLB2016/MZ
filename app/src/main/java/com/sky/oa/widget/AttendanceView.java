...
public class AttendanceView extends View {
    ...
    private void init() {
        ...
        leftTextPad = getContext().getResources().getDimensionPixelSize(R.dimen.wh_16);
        ...
        //设置主标题一级文本字体，颜色，对齐方式
        titlePaint.setTextSize(getContext().getResources().getDimension(R.dimen.text_26));
        titlePaint.setColor(getContext().getResources().getColor(R.color.color_333333));

        //副标题的画笔
        subPaint = new TextPaint();
        subPaint.setTextSize(getContext().getResources().getDimension(R.dimen.text_16));

        textbg = ContextCompat.getDrawable(getContext(), R.drawable.shape_f5f5f5_radius_10);
        //名字的画笔
        itemNamePaint = new TextPaint();
        itemNamePaint.setTextSize(getContext().getResources().getDimension(R.dimen.text_12));
