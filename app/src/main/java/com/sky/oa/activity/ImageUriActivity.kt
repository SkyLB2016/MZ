 ...
 * 加载本地图片
 */
class ImageUriActivity : MVActivity<ActivityUriBinding, ImageUriVM>() {
    //瀑布流布局
...
//                }
    ...
    private fun showImagePop(position: Int) {
        ...
        if (!imagePop.isShowing) imagePop.showAtLocation(binding.swipe.recycler, Gravity.CENTER, 0, 0)
    }
